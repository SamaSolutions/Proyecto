<section class="seccion-contacto-unica">
    <h2 class="titulo-contacto-unica">¡Contáctanos!</h2>
    ...
    <div class="contenedor-bloques-unica">
        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=samasolutions2000@gmail.com&su=Contacto%20desde%20la%20web" target="_blank" class="bloque-contacto-unica bloque-gmail-unica">
            ...
            <span class="texto-contacto-unica">
                samasolutions2000@gmail.com
            </span>
        </a>
    ...
    <details class="lore-proyecto-unica">
        <summary class="lore-boton-unica">
            Acerca de nosotros
        </summary>
        
        <div class="lore-contenido-unica">
            <p><strong>El Lore de SamaSolutions: Conectando el Futuro del Comercio</strong></p>
            <p>
                ¡Bienvenido a nuestro proyecto! SamaSolutions no es solo una plataforma, es la visión convertida en código de un equipo de cuatro amigos con un objetivo común: eliminar las barreras entre el comprador y el vendedor.
            </p>
            <p>
