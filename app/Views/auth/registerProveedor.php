 <div class="registerProveedor-container">
  <div class="registerProveedor-image">
   <img src="images/register.png">
  </div>
  
  <div class="registerProveedor-form"> 
   <h2>Registro de Proveedor</h2>

    <form method="POST" style="max-width: 400px;">
      <fieldset>
       <legend>Datos Personales / De Contacto</legend>
        <br>
        <div>
            <label>CI:</label>
      ...
      <fieldset>
       <legend>Datos Del Proveedor</legend>  
        ...
        <div>
            ...
            <input type="text" name="razon_social" minlength="3" maxlength="100" required value="<?= $this->e($input['razon_social'] ?? '') ?>">
        </div>
        
        <div>
            <label>Especialidad:</label>
            <input type="text" name="especialidad" minlength="3" maxlength="50" required value="<?= $this->e($input['especialidad'] ?? '') ?>">
        </div>
 
        <div>
            <label>Descripcion Del Perfil:</label>
            <br>
            <textarea name="descripcion_del_perfil" rows="4" cols="50" required value="<?= $this->e($input['descripcion_del_perfil'] ?? '') ?>"></textarea>
            </br>
        </div>
        ...
        <div>
            ...
            <br>
            <textarea name="experiencia" rows="4" cols="50" minlength="3" maxlength="50" required value="<?= $this->e($input['experiencia'] ?? '') ?>"></textarea>
            </br>
        </div>
        ...
        <div>
            ...
            <br>
            <textarea name="disponibilidad" rows="4" cols="50" required value="<?= $this->e($input['disponibilidad'] ?? '') ?>"></textarea>
            </br>
        </div>
      </fieldset>
